...
export async function createViews(conn: DuckDBConnection): Promise<void> {
  // Hospital profile - master reference view with clean snake_case aliases
  await conn.run(`
    CREATE OR REPLACE VIEW v_hospital_profile AS
    SELECT
      ...
      TRY_CAST("Hospital overall rating" AS INTEGER)      AS star_rating,
      TRY_CAST("Count of Facility MORT Measures" AS INTEGER) AS mort_measure_count,
      TRY_CAST("Count of MORT Measures Better" AS INTEGER)   AS mort_better,
      TRY_CAST("Count of MORT Measures No Different" AS INTEGER) AS mort_same,
      TRY_CAST("Count of MORT Measures Worse" AS INTEGER)    AS mort_worse,
      TRY_CAST("Count of Facility Safety Measures" AS INTEGER) AS safety_measure_count,
      TRY_CAST("Count of Safety Measures Better" AS INTEGER)   AS safety_better,
      TRY_CAST("Count of Safety Measures No Different" AS INTEGER) AS safety_same,
      TRY_CAST("Count of Safety Measures Worse" AS INTEGER)    AS safety_worse,
      TRY_CAST("Count of Facility READM Measures" AS INTEGER)  AS readm_measure_count,
      TRY_CAST("Count of READM Measures Better" AS INTEGER)    AS readm_better,
      TRY_CAST("Count of READM Measures No Different" AS INTEGER) AS readm_same,
